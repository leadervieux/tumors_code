...
def plot_paper_comparison(K_member):
    """
    Traduction de AB_PlotPaper_True_Predict_simulation_ensemb_HalfFull_1_upd.m
    Visualise la comparaison entre les données synthétiques et les prédictions.
    """
    # --- 1. Chargement des données 'True' (Synthétiques) ---
    try:
        ...
        # Solutions temporelles (Half / Full)
    ...
    # --- 2. Chargement des données 'Estimated' (EnKF) ---
    try:
        enkf_res = loadmat('PlLowfinalResAddNoise_May08-Mar17_K0_theta0_addunc_0p05_C7_249.mat')
        enkf_pred = loadmat('numEns100IterationsForecastAddNoisePlLow_upd_mean_May08-Mar17_K0_theta0_addunc_0p05_C7_249.mat')
        
        updatedEnsemble = enkf_res['updatedEnsemble']
        
        # Moyennes des prédictions mises à jour
        ...
        # Données Full pour la deuxième phase du plot
...
if __name__ == "__main__":
    # On teste avec le membre 7 (comme souvent suggéré dans votre MATLAB)
